...
-- Insert test tenant (matches actual tenants table structure)
INSERT IGNORE INTO tenants (id, name, domain, status, created_at, updated_at)
VALUES ('test-tenant-001', 'Test Company', 'test.callcenter.local', 'active', NOW(), NOW())
...
-- Insert user roles
INSERT IGNORE INTO user_roles (user_id, tenant_id, role, extension, created_at)
VALUES 
...
INSERT IGNORE INTO ps_endpoints (id, transport, aors, auth, context, disallow, allow, direct_media, ice_support, force_rport, rewrite_contact, rtp_symmetric, dtmf_mode, callerid)
VALUES 
...
INSERT IGNORE INTO ps_aors (id, max_contacts, remove_existing, qualify_frequency, authenticate_qualify)
VALUES 
    ('100', 2, 'yes', 60, 'no'),
    ('101', 2, 'yes', 60, 'no')
...
-- Insert test DIDs
INSERT IGNORE INTO dids (number, tenant_id, friendly_name, country_code, status, route_type, route_extension, created_at, updated_at)
VALUES 
...
-- Insert test queues
INSERT IGNORE INTO queues (name, tenant_id, strategy, timeout, max_callers, created_at, updated_at)
VALUES 
...
INSERT IGNORE INTO queue_members (queue_id, user_id, interface, penalty, paused, created_at, updated_at)
VALUES 
...
INSERT IGNORE INTO agent_states (user_id, tenant_id, state, state_duration, last_state_change, created_at, updated_at)
VALUES 
...
INSERT IGNORE INTO contacts (tenant_id, first_name, last_name, phone, email, created_at, updated_at)
VALUES 
...
INSERT IGNORE INTO chat_widgets (tenant_id, name, color, position, welcome_message, is_active, created_at, updated_at)
VALUES 
