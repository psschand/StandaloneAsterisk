...
type TenantResourceUsage struct {
	TenantID           string `json:"tenant_id" example:"acme-corp"`
	UsersCount         int    `json:"users_count" example:"25"`
	MaxAgents          int    `json:"max_agents" example:"50"`
	DIDsCount          int    `json:"dids_count" example:"10"`
	MaxDIDs            int    `json:"max_dids" example:"20"`
	QueuesCount        int    `json:"queues_count" example:"5"`
	MaxConcurrentCalls int    `json:"max_concurrent_calls" example:"25"`
	ActiveCallsCount   int    `json:"active_calls_count" example:"8"`
}
