...
// UpdateDIDRoutingRequest represents DID routing update
// @Description Update phone number routing only
type UpdateDIDRoutingRequest struct {
	RouteType   common.RouteType `json:"route_type" binding:"required" example:"queue"`
	RouteTarget string           `json:"route_target" binding:"required" example:"sales"`
}
...
// UpdateQueueMemberRequest represents queue member update
// @Description Update queue member settings
type UpdateQueueMemberRequest struct {
	Penalty    *int `json:"penalty,omitempty" example:"0"`
	Paused     *int `json:"paused,omitempty" example:"0"`
	WrapupTime *int `json:"wrapuptime,omitempty" example:"0"`
}
...
// CallVolumeResponse represents hourly call volume data
// @Description Hourly call volume breakdown
type CallVolumeResponse struct {
	Hour            int     `json:"hour" example:"14"`
	TotalCalls      int     `json:"total_calls" example:"25"`
	Answered        int     `json:"answered" example:"23"`
	Missed          int     `json:"missed" example:"2"`
	AverageDuration float64 `json:"average_duration" example:"125.5"`
}
